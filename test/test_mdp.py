...
C_maxs, _ = gubs.get_cmax_reachable(init_gridworld.literals, V_risk_gridworld, V_i_gridworld, P_risk_gridworld, goal_test_domain_gridworld, A_gridworld, C_test_domain_gridworld, lamb, k_g, succ_states_gridworld)
